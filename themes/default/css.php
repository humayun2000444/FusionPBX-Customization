...
$menu_main_background_image = $_SESSION['theme']['menu_main_background_image']['text'] ?? null; //humayun
$menu_main_background_color = $_SESSION['theme']['menu_main_background_color']['text'] ?? 'rgba(0, 0, 0, 0.5)';
...
$menu_brand_text_color = $_SESSION['theme']['menu_brand_text_color']['text'] ?? 'rgba(0, 0, 0, 0.5)';
$menu_brand_text_size = $_SESSION['theme']['menu_brand_text_size']['text'] ?? '13pt';
$menu_brand_text_color_hover = $_SESSION['theme']['menu_brand_text_color_hover']['text'] ?? 'rgba(0, 0, 0, 0.5)';
